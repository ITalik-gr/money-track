...
- **🔴 Що далі:** (1) **задеплоїти** — у проді ще версія БЕЗ фіксів безпеки; (2) поставити
  `DEMO_ANTHROPIC_KEY` окремим секретом; (3) L7 — скріншоти в README та на лендінг;
  (4) L8 — ops (перенос історії, Google Cloud test users).
