...
> Оновлено 2026-07-11 (AI 3.0 A–F закрито).
...
1. **Міграції на remote:** застосувати всі до **0018** (`accounts.role` + `accounts.ai_note`, §R3) включно перед деплоєм: `npm run db:migrate:remote`. (Останні фічі — тренд капіталу, дохідна аналітика, календар підписок, аналітика чеків, AI 3.0 — **міграцій не потребують**, крім 0018.)
...
## ➡️ Що далі
Форвард-робота — у **`ROADMAP.md`** (лишилось небагато: TG-бот, дрібні хвости). Основні фази (Аналітика 2.0, Головна, Бюджети, Репорти, Вагомість, Порадник) — закриті, підсумок вище.
