...
1. **Міграції на remote:** застосувати всі до **0017** (`budgets.rollover`) включно перед деплоєм: `npm run db:migrate:remote`. (Останні фічі — тренд капіталу, дохідна аналітика, календар підписок, аналітика чеків — **міграцій не потребують.**)
