...
- **Прогноз темпу (`/analytics/patterns`):** екстраполюємо elapsedFrac ЛИШЕ регулярну частину місяця, разове додаємо плоским (не множимо) — інакше вже сплачений разовий податок роздувався б у «прогноз ×2». `mostly_oneoff` категорії виключені з «Радару аномалій».
