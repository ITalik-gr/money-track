...
> Міграції: `finance` до **0052**, `directory` до **0011**. Тестів — **1050**. Лінти — **C1–C14**.
> Оновлено 2026-09-18.
...
- `worker/lib/messaging/` — вихідні сигнали: `notify` (центр сповіщень: преференції, дедуп,
  ...
  **`drafts-*.ts` — по файлу на КЛАС новини**, і кожен винесено з `notify.ts` під C3 (виняток не
  ...
  фактичні списання розійшлись (§PRICE-STEPS, мертва підписка) · `drafts-goals` · `drafts-budget` ·
