...
> Міграції: `finance` до **0045**, `directory` до **0007**. Тестів — **463**.
...
- **Бюджети-конверти (ліміт ↔ витрачено ↔ прогноз) — `budgetStatus(env, mult, now)`**
  ...
  - **§BUDGET-MEMORY (2026-08-14, міграція 0043): конверт ПАМʼЯТАЄ минулий місяць.**
    ...
    Тримається `budget-memory.test.ts` (15 сценаріїв).
...
Стан на 2026-08-14: міграції `finance` **до 0045**, `directory` **до 0007** (0036–0045 і directory
