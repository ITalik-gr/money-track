...
> Міграції: `finance` до **0045**, `directory` до **0009**. Тестів — **672**.
...
Стан на 2026-08-23: міграції `finance` **до 0045**, `directory` **до 0009** (0036–0045 і directory
0006–**0009** — накотити перед деплоєм; **0008 `tg_links` обовʼязкова, інакше бот не маршрутизує
нікого, крім власника** — див. HISTORY 2026-08-21; **0009 `mcp_version` — без неї видача MCP-токена
падає, а вже виданий не відкликається**),
