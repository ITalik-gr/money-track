...
export const IMPORTANCE_META: Record<Importance, { labelKey: TranslationKey; shortKey: TranslationKey; color: string; hintKey: TranslationKey }> = {
  essential:     { labelKey: "imp.meta.essential.label",     shortKey: "imp.meta.essential.short",     color: "var(--c-teal)", hintKey: "imp.meta.essential.hint" },
  discretionary: { labelKey: "imp.meta.discretionary.label", shortKey: "imp.meta.discretionary.short", color: "var(--c-ochre)", hintKey: "imp.meta.discretionary.hint" },
  optional:      { labelKey: "imp.meta.optional.label",      shortKey: "imp.meta.optional.short",      color: "var(--c-brick)", hintKey: "imp.meta.optional.hint" },
};
