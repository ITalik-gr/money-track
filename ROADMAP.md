...
- Репорти тижневі та місячні щоб робились або на некст ранок, або краще ввечері, бо до цього робило о 12 годині дня, а це майже весь день ще лишається витрачати
- Статистика Скільки коштувала конвертація - коли зведення міняю на долари, то там показує знак долара але по суті то гривні ж.
- Статистика Кумулятивний потік - зараз просто бесполезний, предікт робить просто поступово кожен день знімає скільки в середньому витрачаю, завжди лінія там рівно плавно вниз йде. Треба враховувати більше, підписки отчно, можливо оплату кварити, взагалі якщо ну прямо дуже часто на щось юзер витрачає в дні, чи навпаки заробляє, то це також було б гуд в предікт вписувати, але розумний його зробити. Не треба ж щоб він там кожну транзакцію перераховував через аі, можна раз в день аі юзати на його, чи взагалі як ти пропонуєш. 
- Поправити сторінку статистики коли обрано попередні місяці. Деякі статистики в 0 місяці показують якісь рандомні данні. Також дизайн самих стрілок поправити, і кнопка Місяці дуже схожа на Календарний кнопку.
- Колір тексту на сторінці підписки, в Історія списань - за планом, все так же погано видний на стовпцях, погано читається.
...
### 0.0 Від власника, з живого користування (2026-08-27) — робочий файл `AUDIT-0.0.md`

**Лишилось (рішення власника):**

- **Добовий AI-прохід по кандидатах (~$0.10/міс) — НЕ роблю, поки не скажеш.** Після §SUB-DETECT
  (ритм + домінування ціни) і §AI-RECURRING (здогад на першому списанні) обидва кінці питання
  вже закриті: «має ритм» і «щойно зʼявилось». Третій механізм на те саме питання — це рівно те,
  з чого виростає §CUR-PLAN, і при цьому платний і щоденний. Якщо шум у «Знайдено підписки» таки
  лишиться — скажи, і я зроблю прохід ревʼю саме над цим списком.
