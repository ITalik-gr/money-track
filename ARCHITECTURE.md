...
| 2026-08-07 | tail | §HABITS + adviser sees §WEEKDAY | — | 222 → **232** ✅ | Second new statistic: what quietly joined the regular spending and what went quiet, from what the bank CHARGED rather than from declared plans. Its thresholds are a judgement, so they are unit-tested (8 cases) rather than goldened — the shared fixture has no merchant of that shape, and seeding one would move every other analytics golden. |
