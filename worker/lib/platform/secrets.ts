...
export type SecretName = "mono_token" | "anthropic_api_key" | "privat_credentials" | "jev_api_key";
export const SECRET_NAMES: SecretName[] = ["mono_token", "anthropic_api_key", "privat_credentials", "jev_api_key"];
